    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div>
            <nav>
                ...
                <a href="/proyectos" wire:navigate>Proyectos</a>
            </nav>
        </div>
...
unset($__errorArgs, $__bag); ?> <!-- __ENDBLOCK__ --></span>
                                    ...
                                    <div class="flex justify-end">
                                        ...
                                        <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2"><?php echo e($postId ? 'Agregar' : 'Modificar'); ?></button>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-3">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <!-- __BLOCK__ --><?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <td class="px-6 py-4">
                                <button class="" wire:click="edit(<?php echo e($post->id); ?>)">
                                ...
                                <button class="" onclick="return confirm('¿Está seguro de eliminar este Proyecto?') || event.stopImmediatePropagation()" wire:click="delete(<?php echo e($post->id); ?>)">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ml-2 mt-0 w-4 h-4">
...
<?php /**PATH C:\xampp81\htdocs\2023\enrique\resources\views/livewire/proyecto.blade.php ENDPATH**/ ?>